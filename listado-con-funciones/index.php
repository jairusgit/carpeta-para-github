    ...
    <?php foreach ($_SESSION['personajes'] as $key => $row){ ?>
        <ul>
            ...
            <li>
                ...
                <a href="<?php echo ver($key) ?>" title="Ver">
                    <span class="lnr lnr-eye"></span>
                </a>
                <a href="<?php echo vista("ver.php",$key) ?>" title="Ver">
                    <span class="lnr lnr-eye"></span>
                </a>
                <a href="editar.php?id=<?php echo $key ?>" title="Editar">
                    <span class="lnr lnr-pencil"></span>
                </a>
                <a href="<?php echo vista("editar.php",$key) ?>" title="Ver">
                    <span class="lnr lnr-pencil"></span>
                </a>
                <a href="index.php?action=borrar&id=<?php echo $key ?>" title="Borrar">
                    <span class="lnr lnr-trash"></span>
                </a>
                <a href="<?php echo vista("borrar.php",$key) ?>" title="Ver">
                    <span class="lnr lnr-trash"></span>
                </a>
            </li>
        </ul>
